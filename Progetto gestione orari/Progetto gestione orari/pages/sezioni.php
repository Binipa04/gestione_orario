...
<button onclick="Apri()" id="Apri"><img src="../images/hamMenu.png" alt=""></button>
    ...
    <div id="sidebar">
        ...
        <a class="active" href="sezioni.php"><p><b>SEZIONI</b></p></a>
    ...
    <div id="menu">
            <div id="child1">
                ...
                <div id="listaProf">
                    <!--Qua lasciamo una lista così o facciamo la
                    tabella che avevamo fatto nel progetto prima?
                    Questa opzione sarebbe complicata, da decidere subito-->
                    <ul>
                        <li>5BII</li>
                        <li>4BII</li>
